...
const GCLOUD_BUCKET = 'webportal-frontend-item-bucket';
...
function sendUploadToGCS(req, res, next) {
    ...
    var file_name_string = req.file.originalname
    var file_name_array = file_name_string.split(".");
    var file_extension = file_name_array[file_name_array.length - 1];

    const oname = req.body.itemNumber + '.' + file_extension;

    console.log("Name of the Bucket with Kevin - " + oname);
