$(function() {
    ...
    $('.product-items-active').not('.slick-initialized').slick({
        dots: false,
        infinite: true,
        speed: 600,
        slidesToShow: 3,
    ...
    $('.showcase-active').not('.slick-initialized').slick({
        dots: false,
        infinite: true,
        speed: 600,
        slidesToShow: 1,
    ...
    $('.testimonial-active').not('.slick-initialized').slick({
        dots: false,
        autoplay: true,
        autoplaySpeed: 2000,
        infinite: true,
    ...
    $('.product-image').not('.slick-initialized').slick({
        infinite: true,
        slidesToShow: 1,
        slidesToScroll: 1,
        arrows: true,
